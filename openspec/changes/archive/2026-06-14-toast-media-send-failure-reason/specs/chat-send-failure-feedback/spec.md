...
- **AND** the SDK returns a message with a send error code, returns a failed sending state, or throws a non-antispam send failure with an error code or message
