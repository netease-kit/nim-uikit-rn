...
#### Scenario: Other-client AI mention reply displays AI sender

- **GIVEN** the user is viewing a P2P chat detail page
- **AND** another client mentioned an AI user in the same conversation
- **WHEN** RN receives the AI-generated reply message
- **AND** the message payload or extension identifies the replying AI account
- **THEN** the visible sender name and avatar MUST use the AI account
- **AND** RN MUST NOT display the user who mentioned the AI as the AI reply sender
