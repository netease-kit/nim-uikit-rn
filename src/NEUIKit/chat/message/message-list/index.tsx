...
const MessageList: React.FC<MessageListProps> = observer(
  ({ msgs = [], conversationType, to, loadingMore = false, noMore = false, replyMsgsMap = {} }) => {
    ...
    return (
      <div
        className="msg-list-wrapper"
        onTouchStart={handleTapMessageList}
        onClick={handleTapMessageList}
      >
