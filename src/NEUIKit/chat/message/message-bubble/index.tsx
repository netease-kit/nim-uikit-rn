 ...
 * 消息气泡组件
 */
const MessageBubble: React.FC<MessageBubbleProps> = observer(
  ({ msg, tooltipVisible = true, bgVisible = true, placement = 'top', children }) => {
          ...
          <div className="msg-action-groups-unknown">
            <div className="msg-action-btn" onClick={handleDeleteMsg}>
              <Icon
                size={18}
                style={{ color: '#656A72' }}
                iconClassName="msg-action-btn-icon"
                type="icon-shanchu"
              />
    ...
    const renderSendingMessage = () => (
      <div className="msg-status-wrapper">
        <Icon
          size={21}
          style={{ color: '#337EFF' }}
          iconClassName="msg-status-icon icon-loading"
          type="icon-a-Frame8"
        />
        <Tooltip
          // placement={placement}
    ...
    const renderFailedMessage = () => (
      <div className="msg-failed-wrapper">
        ...
        {msg.messageStatus.errorCode === 102426 && (
          <div className="in-blacklist">{t('sendFailWithInBlackText')}</div>
        )}
      ...
      return (
        <>
          <Tooltip
            ...
            children={
              bgVisible ? <div className="msg-bg msg-bg-in">{children}</div> : <>{children}</>
            }
          ></Tooltip>
          {showForward && (
            <MessageForward
