...
#### Scenario: Picker cancel action returns to the previous page

- **WHEN** the user is on the conversation picker page and taps the left-top cancel action
- **THEN** the page MUST close and return to the previous page
- **AND** the left-top action MUST be presented with the `取消` label
